    ...
    return (
        <div className="boxStyle roundCorner shaDow">
            ...
            <div className="review_add">
                ...
                onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => setContents(e.currentTarget.value)}></textarea>
                <button type="button" onClick={(e:React.MouseEvent) => { commentWrite({e, contents, myMemberId, params, setCommentUpdate}); setContents(''); }}>작성하기</button>
            </div>
        </div>
    )
}
