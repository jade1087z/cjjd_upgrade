...
export const checkId = async (e: React.MouseEvent, formValues: userInterface, setCheckId: React.Dispatch<React.SetStateAction<boolean>>) => {
    e.preventDefault()
    if (formValues.youId) {
...
export const checkNick = async (e: React.MouseEvent, formValues: userInterface, setCheckNick: React.Dispatch<React.SetStateAction<boolean>>) => {
    e.preventDefault()
...
export const checkEmail = async (e: React.MouseEvent, formValues: userInterface, setEmailCheck: React.Dispatch<React.SetStateAction<boolean>>) => {
    e.preventDefault()
